...
import { CCIN_DATA } from './ccin-entry-data';
...
export class CCINComponent {
  apiService = inject(ApiService);
  toasterService = inject(ToastService);

  readonly operationsNames = CCIN_DATA.operationsNames
  readonly operationTypes = CCIN_DATA.operationTypes;
  readonly deliveryTypes = CCIN_DATA.deliveryTypes;
  readonly containerTypes = CCIN_DATA.containerTypes;
  readonly sizes = CCIN_DATA.sizes;
  readonly materialTypes = CCIN_DATA.materialTypes;
